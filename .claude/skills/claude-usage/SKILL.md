...
```
Usage: /claude-usage pro   — Pro plan (opusplan + low effort + haiku subagents)
       /claude-usage 5x    — Max 5x (opusplan + medium effort + haiku subagents)
       /claude-usage 20x   — Max 20x (opus + high effort + sonnet subagents)
```
