...
class AnnotationController extends vscode_1.Disposable {
    ...
    showAnnotations(editor, type, shaOrLine) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return vscode_1.window.withProgress({ location: vscode_1.ProgressLocation.Window }, (progress) => __awaiter(this, void 0, void 0, function* () { return this._showAnnotationsCore(currentProvider, editor, type, shaOrLine, progress); }));
        });
    }
