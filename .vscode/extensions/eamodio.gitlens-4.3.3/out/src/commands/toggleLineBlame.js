...
class ToggleLineBlameCommand extends common_1.EditorCommand {
    constructor(currentLineController) {
        super(common_1.Commands.ToggleLineBlame);
    ...
    execute(editor, edit, uri, args = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                logger_1.Logger.error(ex, 'ToggleLineBlameCommand');
                return vscode_1.window.showErrorMessage(`Unable to toggle line blame annotations. See output channel for more details`);
            }
        });
    }
}
exports.ToggleLineBlameCommand = ToggleLineBlameCommand;
//# sourceMappingURL=toggleLineBlame.js.map