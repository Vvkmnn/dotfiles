            ...
            for (const l of blame.lines) {
                ...
                if (previousSha === l.sha) {
                    ...
                    if (cfg.compact && !compacted) {
                        ...
                        gutter.renderOptions.before = Object.assign({}, gutter.renderOptions.before, { contentText: constants_1.GlyphChars.Space.repeat(gutter.renderOptions.before.contentText.length) });
                        if (separateLines) {
